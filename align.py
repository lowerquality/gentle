...
with open(args.txtfile, mode='r', encoding='utf-8-sig') as fh:
    transcript = fh.read()
...
with gentle.resampled(args.audiofile) as wavfile:
    ...
    aligner = gentle.ForcedAligner(resources, transcript, nthreads=args.nthreads,
                                   disfluency=args.disfluency, conservative=args.conservative, disfluencies=disfluencies)
